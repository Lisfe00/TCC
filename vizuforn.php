...
<html>
    ...
    <table border="1" class="table">
            ...
            <tr>
                ...
                <td> <form class="botoes" method = "post" action="editarforn.php">
    <input type = "hidden" id="inputHidden" name="dataForUpdating" value=<?php echo $dado['cod']; ?> >
      ...
      <button onclick="javascript: if(confirm('Tem certeza que deseja excluir o Fornecedor <?php echo $dado['nome']; ?> ?'))
      location.href='excluirforn.php?codigo=<?php echo $dado['cod']; ?>'"><img class="editar" src="css/img/excluir.png" alt="Imagem não carregada!"></button></td>
            </tr>
            <?php } ?>
        </table>
      </div>
