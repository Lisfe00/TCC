...
<header>
    ...
    <div class="mobile-menu">
        ...
        <ul class="nav-list">
          <li><a onclick="window.location.href ='' " href="#"><img src="css/img/cadastroN.png" width="20" height="20" /> Fornecedor</a></li>
          <li><a onclick="window.location.href ='' " href="#"><img src="css/img/cliente.png" width="20" height="20" /> Cliente</a></li>
          <li><a onclick="window.location.href ='' " href="#"><img src="css/img/org2.png" width="20" height="20" /> Produto</a></li>
          <li><a onclick="window.location.href ='' " href="#"><img src="css/img/venda1.png" width="20" height="20" /> Venda</a></li>
        </ul>
  ...
  <form class="form" method="POST" action="processa_cliente.php">
    <div class="card">
      <div class="card-top">
      ...
      <div class="card-group">
        ...
        <input type="text" name="namec" placeholder="Digite o nome do cliente" required>
      </div>

      <div class="card-group">
        <label>CPF/CNPJ</label>
        <input type="int" name="CPF/CNPJ" placeholder="Digite o CPF/CNPJ do cliente" required>
      </div>

      <div class="card-group">
        <label>Telefone</label>
        <input type="tel" name="fone" placeholder="Digite o telefone do cliente" required>
      </div>
      ...
      <div class="card-group">
        ...
        <input type="text" name="responsavel" placeholder="Digite o nome do responsável pelo recbimento" required>
      </div>

      <div class="card-group">
        <label>Estado</label>
        <select name="est" class="selecao" style="width:336px">
          <?php
      ...
      <div class="card-group">
        ...
        <textarea name="comentarios" rows="3" cols="42" placeholder="Digite a descrição do Cliente"></textarea>
      </div>
